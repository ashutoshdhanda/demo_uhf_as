 ...
 * UHF使用demo
 * 
 * 1、Please make sure your machine has installed this module before use.
 * 2、To use the module normally, you need to place the libDeviceAPI.so file in the \libs\armeabi\ directory, and place the DeviceAPIver20160728.jar file in the \libs\ directory.
 * 3、Before operating the device, you need to call init() to turn on the device, and call free() to turn off the device after use.
 * 
 * 
 * For more functions, please refer to the API documentation
 * 
 * @author
